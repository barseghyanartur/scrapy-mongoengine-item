# -*- coding: utf-8 -*-
#
# scrapy-mongoengine-item documentation build configuration file, created
...
try:
    import scrapy_mongoengine_item
    version = scrapy_mongoengine_item.__version__
    project = scrapy_mongoengine_item.__title__
    copyright = scrapy_mongoengine_item.__copyright__
except Exception as e:
    version = '0.1'
    project = u'scrapy-mongoengine-item'
...
htmlhelp_basename = 'scrapy-mongoengine-itemdoc'
...
latex_documents = [
  ('index',
   'scrapy-mongoengine-item.tex',
   u'scrapy-mongoengine-item Documentation',
...
epub_title = u'scrapy-mongoengine-item'
